...
function setup() {
    ...
    //swordquest
    let sqX = -1500
    bCloud1 = new basicCloud(100 + sqX, 200, 40, 10, 255, 255, 255, 100);
    bCloud2 = new basicCloud(400 + sqX, 200, 40, 10, 255, 255, 255, 100);
    bCloud3 = new basicCloud(700 + sqX, 200, 40, 10, 255, 255, 255, 100);
    bCloud4 = new basicCloud(500 + sqX, 400, 340, 10, 255, 255, 255, 150);
    bCloud5 = new basicCloud(1200 + sqX, 500, 140, 10, 255, 255, 255, 200);
    bCloud6 = new basicCloud(50 + sqX, 700, 40, 10, 255, 255, 255, 50);
    bCloud7 = new basicCloud(170 + sqX, 700, 30, 10, 255, 255, 255, 50);
    bCloud8 = new basicCloud(500 + sqX, 900, 240, 10, 255, 255, 255, 70);
    bCloud9= new basicCloud(1800 + sqX, 400, 40, 10, 255, 255, 255, 90);
